...
def Take_user_inputs(samplenames, input1_dir, input2_dir, output_dir, ChromDict):
	...
	y_limit = Generate_read_coverate_plot(ax1, input1_dir, samplenames[0], chrom, geneID, int(start), int(end), startAll, endAll)

	ax2 = fig.add_subplot(3,1,2)
	ax2.set_xlabel('Position')
	ax2.set_ylabel('Counts')
	y_limit = Generate_read_coverate_plot(ax2, input2_dir, samplenames[1], chrom, geneID, int(start), int(end), startAll, endAll)
...
Take_user_inputs(samplenames, input1_dir, input2_dir, output_dir, ann_list)
